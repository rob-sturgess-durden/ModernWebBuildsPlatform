...
Creates modern, responsive HTML homepages for restaurants from CSV data.
"""
...
def generate_instagram_widget(instagram_handle):
    """Generate Instagram widget HTML for displaying recent posts."""
            ...
            try {{
                ...
                const mockPosts = [
                    {{
                        ...
                        permalink: `https://instagram.com/${{instagramHandle}}`,
                        like_count: 124,
                        comments_count: 8
                    }},
                    {{
...
def main():
    """Main function to process CSV and generate homepages."""
    ...
    print(f"Generating homepages with Instagram widgets in '{output_dir}' directory...\n")
    ...
    for i, restaurant in enumerate(restaurants, 1):
        try:
            ...
            if instagram:
                print(f"   📸 Instagram: @{instagram} (with widget)")
            if facebook:
    ...
    print(f"🎉 Successfully generated {len(restaurants)} restaurant homepages with Instagram widgets!")
    ...
    print("\nNote: Instagram widgets show mock data. For real Instagram integration,")
    print("you would need to use the Instagram Basic Display API with proper authentication.")
